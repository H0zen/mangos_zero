...
struct npc_twiggy_flathead : public CreatureScript
{
    ...
    struct npc_twiggy_flatheadAI : public ScriptedAI
    {
        ...
        void SetChallengers()
        {
            ...
            {
                SummonCreature(*m_creature, NPC_AFFRAY_CHALLENGER, aAffrayChallengerLoc[i][0], aAffrayChallengerLoc[i][1], aAffrayChallengerLoc[i][2], aAffrayChallengerLoc[i][3], TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 600000);
            }
        }
            ...
            if (m_uiEventTimer < uiDiff)
            {
                ...
                switch (m_uiStep)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        SummonCreature(*m_creature, NPC_BIG_WILL, aAffrayChallengerLoc[6][0], aAffrayChallengerLoc[6][1], aAffrayChallengerLoc[6][2], aAffrayChallengerLoc[6][3], TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 300000);
                        m_uiEventTimer = 15000;
                        ++m_uiStep;
                        break;
                    default:
        ...
        void WaypointReached(uint32 uiPointId) override
        {
            switch (uiPointId)
            {
                ...
                case 9:
                    ...
                    break;
                case 17:
                    if (Creature* pTemp = SummonCreature(*m_creature, NPC_MERCENARY, 1128.489f, -3037.611f, 92.701f, 1.472f, TEMPSPAWN_TIMED_OOC_DESPAWN, 120000))
                    {
                        DoScriptText(SAY_MERCENARY, pTemp);
                        SummonCreature(*m_creature, NPC_MERCENARY, 1160.172f, -2980.168f, 97.313f, 3.690f, TEMPSPAWN_TIMED_OOC_DESPAWN, 120000);
                    }
                    break;
                case 24:
                    m_bIsPostEvent = true;
...
struct npc_regthar_deathgate : public CreatureScript
{
    ...
    struct npc_regthar_deathgateAI : public ScriptedAI
    {
        ...
        void UpdateAI(const uint32 uiDiff)
        {
            ...
            {
                m_uiPhaseCount = 3;
                SummonCreature(*m_creature, NPC_KOLKAR_INVADER, SpawnPointsKromzar[0].fX, SpawnPointsKromzar[0].fY, SpawnPointsKromzar[0].fZ, SpawnPointsKromzar[0].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 40000);
                SummonCreature(*m_creature, NPC_WARLORD_KROMZAR, SpawnPointsKromzar[1].fX, SpawnPointsKromzar[1].fY, SpawnPointsKromzar[1].fZ, SpawnPointsKromzar[1].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 40000);
                SummonCreature(*m_creature, NPC_KOLKAR_STORMSEER, SpawnPointsKromzar[2].fX, SpawnPointsKromzar[2].fY, SpawnPointsKromzar[2].fZ, SpawnPointsKromzar[2].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 40000);
            }
            ...
            if (m_uiPhaseCount <= 2 && m_uiWaitSummonTimerHorde < uiDiff && m_uiSummonCountHorde < 7)
            {
                if (m_uiPhaseCount == 2)
                {
                    ...
                    {
                        case 0:
                            SummonCreature(*m_creature, NPC_HORDE_DEFENDER, SpawnPointsHorde[lSpawnListHorde.front()].fX, SpawnPointsHorde[lSpawnListHorde.front()].fY, SpawnPointsHorde[lSpawnListHorde.front()].fZ, SpawnPointsHorde[lSpawnListHorde.front()].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 40000);
                            ++m_uiSummonCountHorde;
                            ...
                            break;
                        case 1:
                            SummonCreature(*m_creature, NPC_HORDE_AXE_THROWER, SpawnPointsHorde[lSpawnListHorde.front()].fX, SpawnPointsHorde[lSpawnListHorde.front()].fY, SpawnPointsHorde[lSpawnListHorde.front()].fZ, SpawnPointsHorde[lSpawnListHorde.front()].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 40000);
                            ++m_uiSummonCountHorde;
                            if (m_uiSummonCountHorde <= 4)
                            {
                                m_uiWaitSummonTimerHorde = 1000;
                ...
                if (m_uiPhaseCount == 1)
                {
                    ...
                    {
                        case 0:
                            SummonCreature(*m_creature, NPC_HORDE_DEFENDER, SpawnPointsHorde[m_uiSummonCountHorde].fX, SpawnPointsHorde[m_uiSummonCountHorde].fY, SpawnPointsHorde[m_uiSummonCountHorde].fZ, SpawnPointsHorde[m_uiSummonCountHorde].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 40000);
                            ++m_uiSummonCountHorde;
                            break;
                        case 1:
                            SummonCreature(*m_creature, NPC_HORDE_AXE_THROWER, SpawnPointsHorde[m_uiSummonCountHorde].fX, SpawnPointsHorde[m_uiSummonCountHorde].fY, SpawnPointsHorde[m_uiSummonCountHorde].fZ, SpawnPointsHorde[m_uiSummonCountHorde].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 40000);
                            ++m_uiSummonCountHorde;
                            break;
                    }
                }
                ...
                if (m_uiPhaseCount <= 2 && m_uiWaitSummonTimer < uiDiff && (m_uiSummonCountInvader + m_uiSummonCountStormseer) < 15)
                {
                    ...
                    if (m_uiSummonCountInvader < 8)
                    {
                        ...
                        if (m_uiPhaseCount == 2)
                        {
                            SummonCreature(*m_creature, NPC_KOLKAR_INVADER, SpawnPointsKolkar[lSpawnList.front()].fX, SpawnPointsKolkar[lSpawnList.front()].fY, SpawnPointsKolkar[lSpawnList.front()].fZ, SpawnPointsKolkar[lSpawnList.front()].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 40000);
                            m_uiWaitSummonTimer = 10000;
                        }

                        if (m_uiPhaseCount == 1)
                        {
                            SummonCreature(*m_creature, NPC_KOLKAR_INVADER, SpawnPointsKolkar[m_uiCreatureCount].fX, SpawnPointsKolkar[m_uiCreatureCount].fY, SpawnPointsKolkar[m_uiCreatureCount].fZ, SpawnPointsKolkar[m_uiCreatureCount].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 40000);
                            ++m_uiCreatureCount;
                        }
                    }
                    ...
                    if (m_uiSummonCountStormseer < 7)
                    {
                        ...
                        if (m_uiPhaseCount == 2)
                        {
                            SummonCreature(*m_creature, NPC_KOLKAR_STORMSEER, SpawnPointsKolkar[lSpawnList.front()].fX, SpawnPointsKolkar[lSpawnList.front()].fY, SpawnPointsKolkar[lSpawnList.front()].fZ, SpawnPointsKolkar[lSpawnList.front()].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 40000);
                            m_uiWaitSummonTimer = 10000;
                        }

                        if (m_uiPhaseCount == 1)
                        {
                            SummonCreature(*m_creature, NPC_KOLKAR_STORMSEER, SpawnPointsKolkar[m_uiCreatureCount].fX, SpawnPointsKolkar[m_uiCreatureCount].fY, SpawnPointsKolkar[m_uiCreatureCount].fZ, SpawnPointsKolkar[m_uiCreatureCount].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 40000);
                            ++m_uiCreatureCount;
                        }
                    }
