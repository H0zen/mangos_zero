...
struct npc_ranshalla : public CreatureScript
{
    ...
    struct npc_ranshallaAI : public npc_escortAI, private DialogueHelper
    {
        ...
        void DoSummonPriestess()
        {
            ...
            if (Creature* pPriestess = SummonCreature(*m_creature, NPC_PRIESTESS_ELUNE, aWingThicketLocations[0].m_fX, aWingThicketLocations[0].m_fY, aWingThicketLocations[0].m_fZ, aWingThicketLocations[0].m_fO, TEMPSPAWN_CORPSE_DESPAWN, 0))
            {
            ...
            if (Creature* pPriestess = SummonCreature(*m_creature, NPC_PRIESTESS_ELUNE, aWingThicketLocations[1].m_fX, aWingThicketLocations[1].m_fY, aWingThicketLocations[1].m_fZ, aWingThicketLocations[1].m_fO, TEMPSPAWN_CORPSE_DESPAWN, 0))
            {
        ...
        void JustDidDialogueStep(int32 iEntry) override
        {
            switch (iEntry)
            {
                ...
                case SAY_PRIESTESS_ALTAR_13:
                    ...
                    if (Creature* pGuard = SummonCreature(*m_creature, NPC_GUARDIAN_ELUNE, aWingThicketLocations[2].m_fX, aWingThicketLocations[2].m_fY, aWingThicketLocations[2].m_fZ, aWingThicketLocations[2].m_fO, TEMPSPAWN_CORPSE_DESPAWN, 0))
                    {
                    ...
                    if (GameObject* pAltar = m_creature->GetMap()->GetGameObject(m_altarGuid))
                    {
                        if (Creature* pVoice = SummonCreature(*m_creature, NPC_VOICE_ELUNE, pAltar->Where().X(), pAltar->Where().Y(), pAltar->Where().Z(), 0, TEMPSPAWN_TIMED_DESPAWN, 30000))
                        {
