...
struct is_dire_maul : public InstanceScript
{
    ...
    class instance_dire_maul : public ScriptedInstance
    {
        public:
                    ...
                    case TYPE_KING_GORDOK:
                        ...
                        if (uiData == DONE)
                        {
                            if (Creature* pOgre = GetSingleCreatureFromStorage(NPC_CHORUSH))
                            {
                                ...
                                if (Creature* pMizzle = SummonCreature(*pOgre, NPC_MIZZLE_THE_CRAFTY, afMizzleSpawnLoc[0], afMizzleSpawnLoc[1], afMizzleSpawnLoc[2], afMizzleSpawnLoc[3], TEMPSPAWN_DEAD_DESPAWN, 0, true))
                                {
            ...
            bool CheckConditionCriteriaMeet(Player const* pPlayer, uint32 uiInstanceConditionId, Occupant const* pConditionSource, uint32 conditionSourceType) const override
            {
