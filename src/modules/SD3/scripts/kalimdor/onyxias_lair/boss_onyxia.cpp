...
struct boss_onyxia : public CreatureScript
{
    ...
    struct boss_onyxiaAI : public ScriptedAI
    {
        ...
        bool DidSummonWhelps(const uint32 uiDiff)
        {
            ...
            {
                SummonCreature(*m_creature, NPC_ONYXIA_WHELP, afSpawnLocations[0][0], afSpawnLocations[0][1], afSpawnLocations[0][2], 0.0f, TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, MINUTE * IN_MILLISECONDS);
                SummonCreature(*m_creature, NPC_ONYXIA_WHELP, afSpawnLocations[1][0], afSpawnLocations[1][1], afSpawnLocations[1][2], 0.0f, TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, MINUTE * IN_MILLISECONDS);
                m_uiWhelpTimer = 500;
            }
            else
            {
