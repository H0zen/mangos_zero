...
struct npc_muglash : public CreatureScript
{
    ...
    struct npc_muglashAI : public npc_escortAI
    {
        ...
        void DoWaveSummon()
        {
            ...
            {
                case 1:
                    SummonCreature(*m_creature, NPC_WRATH_RIDER, m_afFirstNagaCoord[0][0], m_afFirstNagaCoord[0][1], m_afFirstNagaCoord[0][2], 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 60000);
                    SummonCreature(*m_creature, NPC_WRATH_SORCERESS, m_afFirstNagaCoord[1][0], m_afFirstNagaCoord[1][1], m_afFirstNagaCoord[1][2], 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 60000);
                    SummonCreature(*m_creature, NPC_WRATH_RAZORTAIL, m_afFirstNagaCoord[2][0], m_afFirstNagaCoord[2][1], m_afFirstNagaCoord[2][2], 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 60000);
                    break;
                case 2:
                    SummonCreature(*m_creature, NPC_WRATH_PRIESTESS, m_afSecondNagaCoord[0][0], m_afSecondNagaCoord[0][1], m_afSecondNagaCoord[0][2], 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 60000);
                    SummonCreature(*m_creature, NPC_WRATH_MYRMIDON, m_afSecondNagaCoord[1][0], m_afSecondNagaCoord[1][1], m_afSecondNagaCoord[1][2], 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 60000);
                    SummonCreature(*m_creature, NPC_WRATH_SEAWITCH, m_afSecondNagaCoord[2][0], m_afSecondNagaCoord[2][1], m_afSecondNagaCoord[2][2], 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 60000);
                    break;
                case 3:
                    SummonCreature(*m_creature, NPC_VORSHA, m_fVorshaCoord[0], m_fVorshaCoord[1], m_fVorshaCoord[2], 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 60000);
                    break;
                case 4:
...
struct npc_ruul_snowhoof : public CreatureScript
{
    ...
    struct npc_ruul_snowhoofAI : public npc_escortAI
    {
        ...
        void WaypointReached(uint32 uiPointId) override
        {
            ...
            {
                case 13:
                    SummonCreature(*m_creature, NPC_T_TOTEMIC, 3449.218018f, -587.825073f, 174.978867f, 4.714445f, TEMPSPAWN_DEAD_DESPAWN, 60000);
                    SummonCreature(*m_creature, NPC_T_URSA, 3446.384521f, -587.830872f, 175.186279f, 4.714445f, TEMPSPAWN_DEAD_DESPAWN, 60000);
                    SummonCreature(*m_creature, NPC_T_PATHFINDER, 3444.218994f, -587.835327f, 175.380600f, 4.714445f, TEMPSPAWN_DEAD_DESPAWN, 60000);
                    break;
                case 19:
                    SummonCreature(*m_creature, NPC_T_TOTEMIC, 3508.344482f, -492.024261f, 186.929031f, 4.145029f, TEMPSPAWN_DEAD_DESPAWN, 60000);
                    SummonCreature(*m_creature, NPC_T_URSA, 3506.265625f, -490.531006f, 186.740128f, 4.239277f, TEMPSPAWN_DEAD_DESPAWN, 60000);
                    SummonCreature(*m_creature, NPC_T_PATHFINDER, 3503.682373f, -489.393799f, 186.629684f, 4.349232f, TEMPSPAWN_DEAD_DESPAWN, 60000);
                    break;
                case 21:
                    if (Player* pPlayer = GetPlayerForEscort())
                    {
        ...
        void WaypointReached(uint32 uiPointId) override
        {
            ...
            switch (uiPointId)
            {
                ...
                case 19:
                    ...
                    SummonCreature(*m_creature, NPC_DURIEL, 1776.73f, -2049.06f, 109.83f, 1.54f, TEMPSPAWN_TIMED_OOC_DESPAWN, 25000);
                    SummonCreature(*m_creature, NPC_SILVERWING_SENTINEL, 1774.64f, -2049.41f, 109.83f, 1.40f, TEMPSPAWN_TIMED_OOC_DESPAWN, 25000);
                    SummonCreature(*m_creature, NPC_SILVERWING_WARRIOR, 1778.73f, -2049.50f, 109.83f, 1.67f, TEMPSPAWN_TIMED_OOC_DESPAWN, 25000);
                    break;
                case 20:
...
struct npc_feero_ironhand : public CreatureScript
{
    ...
    struct npc_feero_ironhandAI : public npc_escortAI
    {
        ...
        void WaypointReached(uint32 uiPointId) override
        {
            switch (uiPointId)
            {
                ...
                case 29:
                    ...
                    SummonCreature(*m_creature, NPC_BALIZAR_THE_UMBRAGE, aEliteSummonPositions[0][0], aEliteSummonPositions[0][1], aEliteSummonPositions[0][2], aEliteSummonPositions[0][3], TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
                    SummonCreature(*m_creature, NPC_ALIGAR_THE_TORMENTOR, aEliteSummonPositions[1][0], aEliteSummonPositions[1][1], aEliteSummonPositions[1][2], aEliteSummonPositions[1][3], TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
                    SummonCreature(*m_creature, NPC_CAEDAKAR_THE_VICIOUS, aEliteSummonPositions[2][0], aEliteSummonPositions[2][1], aEliteSummonPositions[2][2], aEliteSummonPositions[2][3], TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
                    break;
                case 30:
                    // Complete the quest
                    if (Player* pPlayer = GetPlayerForEscort())
        ...
        void DoSpawnMob(uint32 uiEntry, float fDistance, float fAngle)
        {
            ...
            SummonCreature(*m_creature, uiEntry, fX, fY, fZ, 0, TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
        }
