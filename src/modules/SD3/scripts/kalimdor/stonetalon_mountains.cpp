        ...
        void WaypointReached(uint32 uiPointId) override
        {
            switch (uiPointId)
            {
                ...
                case 16:
                    ...
                    SummonCreature(*m_creature, NPC_GRIMTOTEM_RUFFIAN, -50.75f, -500.77f, -46.13f, 0.4f, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 30000);
                    SummonCreature(*m_creature, NPC_GRIMTOTEM_BRUTE, -40.05f, -510.89f, -46.05f, 1.7f, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 30000);
                    SummonCreature(*m_creature, NPC_GRIMTOTEM_SORCERER, -32.21f, -499.20f, -45.35f, 2.8f, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 30000);
                    break;
                // Award quest credit
                case 18:
        ...
        void UpdateAI(const uint32 uiDiff)
        {
            ...
            if (m_bEventStarted && !m_uiSummonCount)
            {
                ...
                if (m_uiWaveTimer < uiDiff && m_uiWaveCount <= 2)
                {
                    ...
                    {
                        case 0:
                            SummonCreature(*m_creature, NPC_WINDSHEAR_VERMIN, SpawnPointsst[2].fX, SpawnPointsst[2].fY, SpawnPointsst[2].fZ, SpawnPointsst[2].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 20000);
                            SummonCreature(*m_creature, NPC_WINDSHEAR_TUNNEL_RAT, SpawnPointsst[0].fX, SpawnPointsst[0].fY, SpawnPointsst[0].fZ, SpawnPointsst[0].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 20000);
                            SummonCreature(*m_creature, NPC_WINDSHEAR_VERMIN, SpawnPointsst[1].fX, SpawnPointsst[1].fY, SpawnPointsst[1].fZ, SpawnPointsst[1].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 20000);
                            m_uiWaveTimer = 45000;
                            m_uiMoveCount = 0;
                            break;
                        case 1:
                            SummonCreature(*m_creature, NPC_WINDSHEAR_GEOMANCER, SpawnPointsst[2].fX, SpawnPointsst[2].fY, SpawnPointsst[2].fZ, SpawnPointsst[2].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 20000);
                            SummonCreature(*m_creature, NPC_WINDSHEAR_STONECUTTER, SpawnPointsst[0].fX, SpawnPointsst[0].fY, SpawnPointsst[0].fZ, SpawnPointsst[0].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 20000);
                            SummonCreature(*m_creature, NPC_WINDSHEAR_GEOMANCER, SpawnPointsst[1].fX, SpawnPointsst[1].fY, SpawnPointsst[1].fZ, SpawnPointsst[1].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 20000);
                            SummonCreature(*m_creature, NPC_WINDSHEAR_STONECUTTER, SpawnPointsst[3].fX, SpawnPointsst[3].fY, SpawnPointsst[3].fZ, SpawnPointsst[3].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 20000);
                            m_uiWaveTimer = 45000;
                            m_uiMoveCount = 0;
                            break;
                        case 2:
                            SummonCreature(*m_creature, NPC_WINDSHEAR_TUNNEL_RAT, SpawnPointsst[2].fX, SpawnPointsst[2].fY, SpawnPointsst[2].fZ, SpawnPointsst[2].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 20000);
                            SummonCreature(*m_creature, NPC_WINDSHEAR_OVERLORD, SpawnPointsst[0].fX, SpawnPointsst[0].fY, SpawnPointsst[0].fZ, SpawnPointsst[0].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 20000);
                            SummonCreature(*m_creature, NPC_WINDSHEAR_TUNNEL_RAT, SpawnPointsst[1].fX, SpawnPointsst[1].fY, SpawnPointsst[1].fZ, SpawnPointsst[1].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 20000);
                            SummonCreature(*m_creature, NPC_WINDSHEAR_TUNNEL_RAT, SpawnPointsst[3].fX, SpawnPointsst[3].fY, SpawnPointsst[3].fZ, SpawnPointsst[3].fO, TEMPSPAWN_CORPSE_TIMED_DESPAWN, 20000);
                            m_uiMoveCount = 0;
                            break;
                    }
