...
class WorldSession
{
    ...
    public:
        ...
        /// SMSG_AUCTION_COMMAND_RESULT from raw values, so a caller that no
        /// longer holds a live AuctionEntry can still emit the result.
        ...
        /// SMSG_AUCTION_BIDDER_NOTIFICATION from raw values.
        ...
        /// SMSG_AUCTION_OWNER_NOTIFICATION from raw values, so it can be emitted
        /// without a live AuctionEntry.
        ...
        /// SMSG_AUCTION_REMOVED_NOTIFICATION from raw values, so it can be
        /// emitted without a live AuctionEntry.
