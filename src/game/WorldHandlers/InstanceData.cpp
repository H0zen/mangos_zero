 ...
 * @param conditionSource Occupant triggering the condition check
 ...
 */
bool InstanceData::CheckConditionCriteriaMeet(Player const* /*source*/, uint32 instance_condition_id, Occupant const* /*conditionSource*/, uint32 conditionSourceType) const
{
