...
enum SpellModOp
{
    ...
    SPELLMOD_SPEED = 12,                ///< Speed modifier
    // spellmod 13 unused
...
class Unit : public Occupant
{
    public:
         ...
         * @param except select any target but this one, usually your current target
         * @return The injured friendly target found, nullptr if no targets were found
         * \see Mangos::UnitListSearcher
         * \see Cell::VisitAllObjects
         */
         ...
         * @param except select any target but this one, usually your current target
         * @return The friendly target found, nullptr if no targets were found
         * \see Mangos::UnitListSearcher
         * \see Cell::VisitAllObjects
         */
