...
enum MangosStrings
{
    ...
    LANG_WAYPOINT_NOTFOUNDPATH                                = 222,
    LANG_WAYPOINT_NOTFOUNDDBPROBLEM                           = 223,
    LANG_WAYPOINT_NOTFOUND_NPC                                = 224,
    ...
    LANG_WAYPOINT_INFO_ORI                                    = 248,
    LANG_WAYPOINT_INFO_SCRIPTID                               = 249,
    LANG_WAYPOINT_INFO_UNK_SCRIPTID                           = 250,
    ...
    LANG_BG_GROUP_TOO_LARGE                                   = 720,
    LANG_BG_GROUP_OFFLINE_MEMBER                              = 727,
    LANG_BG_GROUP_MIXED_FACTION                               = 728,
    LANG_BG_GROUP_MIXED_LEVELS                                = 729,
    LANG_BG_GROUP_MEMBER_ALREADY_IN_QUEUE                     = 730,
    LANG_BG_GROUP_MEMBER_DESERTER                             = 731,
    LANG_BG_GROUP_MEMBER_NO_FREE_QUEUE_SLOTS                  = 732,
    LANG_CANNOT_TELE_TO_BG                                    = 733,
    LANG_CANNOT_SUMMON_TO_BG                                  = 734,
    LANG_CANNOT_GO_TO_BG_GM                                   = 735,
    LANG_CANNOT_GO_TO_BG_FROM_BG                              = 736,
    LANG_DEBUG_BG_ON                                          = 739,
    LANG_DEBUG_BG_OFF                                         = 740,
    LANG_MAP_IS_DISABLED                                      = 747,
    LANG_BATTLEGROUND_PREMATURE_FINISH_WARNING                = 750,
    LANG_BATTLEGROUND_PREMATURE_FINISH_WARNING_SECS           = 751,
    LANG_BATTLEGROUND_ONLY_ALLIANCE_USE                       = 752,
    LANG_BATTLEGROUND_ONLY_HORDE_USE                          = 753,
    ...
    LANG_COMMAND_RESET_ITEMS_EQUIPED                          = 1522,
    LANG_COMMAND_RESET_ITEMS_BAGS                             = 1523,
    LANG_COMMAND_RESET_ITEMS_BANK                             = 1524,
    LANG_COMMAND_RESET_ITEMS_KEYRING                          = 1525,
    LANG_COMMAND_RESET_ITEMS_BUYBACK                          = 1526,
    ...
    LANG_COMMAND_AURAGROUP_CANNOT_APPLY_AURA_PLAYER_IS_DEAD   = 1701,
    LANG_COMMAND_AURAGROUP_AURA_APPLIED                       = 1702,
    LANG_COMMAND_AURAGROUP_CANNOT_UNAURA_DEAD_PLAYER          = 1703,
    LANG_COMMAND_AURAGROUP_ALL_AURA_REMOVED                   = 1704,
    LANG_COMMAND_AURAGROUP_AURA_REMOVED_FOR_SPELL             = 1705,
    LANG_COMMAND_EXECUTE_GOCRE_ANOTHER_TIME                   = 1706,
    LANG_COMMAND_FREEZE_PLAYER                                = 1707,
    LANG_COMMAND_UNFREEZE_PLAYER                              = 1708,
    LANG_COMMAND_FREEZE_PLAYER_CANNOT_FREEZE_HIGHER_SECLEVEL  = 1709,
    LANG_COMMAND_FREEZE_PLAYER_CANNOT_FREEZE_YOURSELF         = 1710,
    LANG_COMMAND_FREEZE_PLAYER_YOU_HAVE_BEEN_FROZEN           = 1711,
    LANG_COMMAND_FREEZE_PLAYER_YOU_HAVE_BEEN_UNFROZEN         = 1712,
    LANG_COMMAND_FREEZE_PLAYER_PLAYER_NOT_FOUND               = 1713,
    LANG_COMMAND_UNFREEZE_PLAYER_PLAYER_NOT_FOUND             = 1714,
    LANG_CANNOT_ENTER_CHAMPIONS_HALL                          = 1715,
    LANG_CANNOT_ENTER_LEGENDS_HALL                            = 1716,
