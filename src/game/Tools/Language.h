...
enum MangosStrings
{
    ...
    LANG_SCHEDULED_EXIT_RESTART_15_MIN                        = 1730,    /* This realm will be automatically restarting in 15 Minutes as part of its weekly schedule. Downtime is expected to be 1-2 minutes. */
    LANG_SCHEDULED_EXIT_RESTART_10_MIN                        = 1731,    /* This realm will be automatically restarting in 10 Minutes. */
    LANG_SCHEDULED_EXIT_RESTART_5_MIN                         = 1732,    /* This realm will be automatically restarting in 5 Minutes. */
    LANG_SCHEDULED_EXIT_RESTART_1_MIN                         = 1733,    /* This realm will be automatically restarting in 1 Minute as part of its weekly schedule. Please ensure you are in a safe area. Downtime is expected to be 1-2 minutes. */
    LANG_SCHEDULED_EXIT_SHUTDOWN_15_MIN                       = 1734,    /* This realm will be automatically shutting down in 15 Minutes as part of its weekly schedule. Downtime is expected to be 1-2 minutes. */
    LANG_SCHEDULED_EXIT_SHUTDOWN_10_MIN                       = 1735,    /* This realm will be automatically shutting down in 10 Minutes. */
    LANG_SCHEDULED_EXIT_SHUTDOWN_5_MIN                        = 1736,    /* This realm will be automatically shutting down in 5 Minutes. */
    LANG_SCHEDULED_EXIT_SHUTDOWN_1_MIN                        = 1737,    /* This realm will be automatically shutting down in 1 Minute as part of its weekly schedule. Please ensure you are in a safe area. Downtime is expected to be 1-2 minutes. */
