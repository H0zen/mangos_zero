...
/// @param id - MapId of the to be created map. @param obj Occupant for which the map is to be created. Must be player for Instancable maps.
Map* MapManager::CreateMap(uint32 id, const Occupant* obj)
{
