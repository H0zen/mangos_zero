...
using GridTypeMapContainer  = TypeMapContainer<TypeList<GameObject, Creature, DynamicObject, Corpse>>;
using WorldTypeMapContainer = TypeMapContainer<TypeList<Player, Creature, Corpse, Camera>>;
