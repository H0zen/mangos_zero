...
class BattleGroundWS : public BattleGround
{
    ...
    public:
        ...
        bool IsAllianceFlagPickedUp() const { return !(m_flagCarrierAlliance == 0); }

        bool IsHordeFlagPickedUp() const { return !(m_flagCarrierHorde == 0); }
    ...
    private:
        ObjectGuid m_flagCarrierAlliance = 0;
        ObjectGuid m_flagCarrierHorde = 0;
