...
enum EItemFields
{
    ...
    ITEM_FIELD_PROPERTY_SEED                   = OBJECT_END + 0x25,
    ITEM_FIELD_RANDOM_PROPERTIES_ID            = OBJECT_END + 0x26,
    ITEM_FIELD_ITEM_TEXT_ID                    = OBJECT_END + 0x27,
    ITEM_FIELD_DURABILITY                      = OBJECT_END + 0x28,
    ITEM_FIELD_MAXDURABILITY                   = OBJECT_END + 0x29,
...
enum EUnitFields
{
    UNIT_FIELD_CHARM                           = 0x00 + OBJECT_END,
    UNIT_FIELD_SUMMON                          = 0x02 + OBJECT_END,
    UNIT_FIELD_CHARMEDBY                       = 0x04 + OBJECT_END,
    UNIT_FIELD_SUMMONEDBY                      = 0x06 + OBJECT_END,
    UNIT_FIELD_CREATEDBY                       = 0x08 + OBJECT_END,
    UNIT_FIELD_TARGET                          = 0x0A + OBJECT_END,
    UNIT_FIELD_PERSUADED                       = 0x0C + OBJECT_END,
    UNIT_FIELD_CHANNEL_OBJECT                  = 0x0E + OBJECT_END,
    ...
    PLAYER_DUEL_ARBITER                        = 0x00 + UNIT_END,
    PLAYER_FLAGS                               = 0x02 + UNIT_END,
    PLAYER_GUILDID                             = 0x03 + UNIT_END,
    PLAYER_GUILDRANK                           = 0x04 + UNIT_END,
    PLAYER_BYTES                               = 0x05 + UNIT_END,
    PLAYER_BYTES_2                             = 0x06 + UNIT_END,
    PLAYER_BYTES_3                             = 0x07 + UNIT_END,
    PLAYER_DUEL_TEAM                           = 0x08 + UNIT_END,
    PLAYER_GUILD_TIMESTAMP                     = 0x09 + UNIT_END,
    PLAYER_QUEST_LOG_1_1                       = 0x0A + UNIT_END,
    ...
    PLAYER_VISIBLE_ITEM_1_CREATOR              = 0x46 + UNIT_END,
    PLAYER_VISIBLE_ITEM_1_0                    = 0x48 + UNIT_END,
    PLAYER_VISIBLE_ITEM_1_PROPERTIES           = 0x50 + UNIT_END,
    PLAYER_VISIBLE_ITEM_1_PAD                  = 0x51 + UNIT_END,
    ...
    PLAYER_FIELD_INV_SLOT_HEAD                 = 0x12a + UNIT_END,
    PLAYER_FIELD_PACK_SLOT_1                   = 0x158 + UNIT_END,
    PLAYER_FIELD_PACK_SLOT_LAST                = 0x176 + UNIT_END,
    PLAYER_FIELD_BANK_SLOT_1                   = 0x178 + UNIT_END,
    PLAYER_FIELD_BANK_SLOT_LAST                = 0x1a6 + UNIT_END,
    PLAYER_FIELD_BANKBAG_SLOT_1                = 0x1a8 + UNIT_END,
    PLAYER_FIELD_BANKBAG_SLOT_LAST             = 0x1b2 + UNIT_END,
    PLAYER_FIELD_VENDORBUYBACK_SLOT_1          = 0x1b4 + UNIT_END,
    PLAYER_FIELD_VENDORBUYBACK_SLOT_LAST       = 0x1ca + UNIT_END,
    PLAYER_FIELD_KEYRING_SLOT_1                = 0x1cc + UNIT_END,
    PLAYER_FIELD_KEYRING_SLOT_LAST             = 0x20a + UNIT_END,
    PLAYER_FARSIGHT                            = 0x20c + UNIT_END,
    PLAYER_FIELD_COMBO_TARGET                  = 0x20e + UNIT_END,
    PLAYER_XP                                  = 0x210 + UNIT_END,
    PLAYER_NEXT_LEVEL_XP                       = 0x211 + UNIT_END,
    PLAYER_SKILL_INFO_1_1                      = 0x212 + UNIT_END,
    PLAYER_CHARACTER_POINTS1                   = 0x392 + UNIT_END,
    PLAYER_CHARACTER_POINTS2                   = 0x393 + UNIT_END,
    PLAYER_TRACK_CREATURES                     = 0x394 + UNIT_END,
    PLAYER_TRACK_RESOURCES                     = 0x395 + UNIT_END,
    PLAYER_BLOCK_PERCENTAGE                    = 0x396 + UNIT_END,
    PLAYER_DODGE_PERCENTAGE                    = 0x397 + UNIT_END,
    PLAYER_PARRY_PERCENTAGE                    = 0x398 + UNIT_END,
    PLAYER_CRIT_PERCENTAGE                     = 0x399 + UNIT_END,
    PLAYER_RANGED_CRIT_PERCENTAGE              = 0x39a + UNIT_END,
    PLAYER_EXPLORED_ZONES_1                    = 0x39b + UNIT_END,
    PLAYER_REST_STATE_EXPERIENCE               = 0x3db + UNIT_END,
    PLAYER_FIELD_COINAGE                       = 0x3dc + UNIT_END,
    PLAYER_FIELD_POSSTAT0                      = 0x3DD + UNIT_END,
    PLAYER_FIELD_POSSTAT1                      = 0x3DE + UNIT_END,
    PLAYER_FIELD_POSSTAT2                      = 0x3DF + UNIT_END,
    PLAYER_FIELD_POSSTAT3                      = 0x3E0 + UNIT_END,
    PLAYER_FIELD_POSSTAT4                      = 0x3E1 + UNIT_END,
    PLAYER_FIELD_NEGSTAT0                      = 0x3E2 + UNIT_END,
    PLAYER_FIELD_NEGSTAT1                      = 0x3E3 + UNIT_END,
    PLAYER_FIELD_NEGSTAT2                      = 0x3E4 + UNIT_END,
    PLAYER_FIELD_NEGSTAT3                      = 0x3E5 + UNIT_END,
    PLAYER_FIELD_NEGSTAT4                      = 0x3E6 + UNIT_END,
    PLAYER_FIELD_RESISTANCEBUFFMODSPOSITIVE    = 0x3E7 + UNIT_END,
    PLAYER_FIELD_RESISTANCEBUFFMODSNEGATIVE    = 0x3EE + UNIT_END,
    PLAYER_FIELD_MOD_DAMAGE_DONE_POS           = 0x3F5 + UNIT_END,
    PLAYER_FIELD_MOD_DAMAGE_DONE_NEG           = 0x3FC + UNIT_END,
    PLAYER_FIELD_MOD_DAMAGE_DONE_PCT           = 0x403 + UNIT_END,
    PLAYER_FIELD_BYTES                         = 0x40A + UNIT_END,
    PLAYER_AMMO_ID                             = 0x40B + UNIT_END,
    PLAYER_SELF_RES_SPELL                      = 0x40C + UNIT_END,
    PLAYER_FIELD_PVP_MEDALS                    = 0x40D + UNIT_END,
    PLAYER_FIELD_BUYBACK_PRICE_1               = 0x40E + UNIT_END,
    PLAYER_FIELD_BUYBACK_PRICE_LAST            = 0x419 + UNIT_END,
    PLAYER_FIELD_BUYBACK_TIMESTAMP_1           = 0x41A + UNIT_END,
    PLAYER_FIELD_BUYBACK_TIMESTAMP_LAST        = 0x425 + UNIT_END,
    PLAYER_FIELD_SESSION_KILLS                 = 0x426 + UNIT_END,
    PLAYER_FIELD_YESTERDAY_KILLS               = 0x427 + UNIT_END,
    PLAYER_FIELD_LAST_WEEK_KILLS               = 0x428 + UNIT_END,
    PLAYER_FIELD_THIS_WEEK_KILLS               = 0x429 + UNIT_END,
    PLAYER_FIELD_THIS_WEEK_CONTRIBUTION        = 0x42a + UNIT_END,
    PLAYER_FIELD_LIFETIME_HONORABLE_KILLS      = 0x42b + UNIT_END,
    PLAYER_FIELD_LIFETIME_DISHONORABLE_KILLS   = 0x42c + UNIT_END,
    PLAYER_FIELD_YESTERDAY_CONTRIBUTION        = 0x42d + UNIT_END,
    PLAYER_FIELD_LAST_WEEK_CONTRIBUTION        = 0x42e + UNIT_END,
    PLAYER_FIELD_LAST_WEEK_RANK                = 0x42f + UNIT_END,
    PLAYER_FIELD_BYTES2                        = 0x430 + UNIT_END,
    PLAYER_FIELD_WATCHED_FACTION_INDEX         = 0x431 + UNIT_END,
    PLAYER_FIELD_COMBAT_RATING_1               = 0x432 + UNIT_END,
...
enum ECorpseFields
{
    ...
    CORPSE_FIELD_ITEM                          = OBJECT_END + 0x07,
