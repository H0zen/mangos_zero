...
*Recast* and *utf8cpp* are included in the *Mangos* distribution as we rely on
specific versions. The MPQ archives are read by this tree's own reader in
`src/shared/ClientArchive`, so no MPQ library is bundled.
